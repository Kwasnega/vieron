...
const AdminDashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const mockAdminRoles = ['SuperAdmin', 'HOD', 'Dean', 'Exam Officer', 'Registrar'];
      ...
      <Box sx={{ flexGrow: 1, bgcolor: 'background.default', minHeight: '100vh' }}>
        ...
        <Container maxWidth="xl" sx={{ mt: 3 }}>
          ...
          <TabPanel value={tabValue} index={0}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} sm={6} md={4}>
                <Card>
                  <CardContent>
                    <Typography variant="h6" gutterBottom>Queue Now</Typography>
                    <Typography variant="h3" color="primary">{mockComplaints.length + mockResultIssues.length}</Typography>
                  </CardContent>
                </Card>
              </Grid>
              <Grid item xs={12} sm={6} md={4}>
                <Card>
                  <CardContent>
                    <Typography variant="h6" gutterBottom>Pending Complaints</Typography>
                    <Typography variant="h3" color="primary">{mockComplaints.filter(c => c.status === 'pending' || c.status === 'Queued').length}</Typography>
                  </CardContent>
                </Card>
              </Grid>
              <Grid item xs={12}>
          ...
          <TabPanel value={tabValue} index={3}>
            <Card>
              <CardContent>
                <Typography variant="h6" gutterBottom>Inactive Items</Typography>
                <Alert severity="info" sx={{ mb: 2 }}>
                  Complaints and result issues that have been marked as inactive. Items can be restored or permanently deleted.
                </Alert>
                <Typography variant="body2" color="text.secondary">
